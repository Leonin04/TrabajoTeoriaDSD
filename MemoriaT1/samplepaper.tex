...
\begin{itemize}
    \item \textbf{Proponente (Julian Carrión Tovar):} Encargado de argumentar las ventajas y la utilidad de integrar GenAI en sistemas distribuidos, destacando casos de uso reales y beneficios.
...
\section{Ejemplos del uso de esta tecnología en la actualidad (Rol: Proporcionador de ejemplos)}
